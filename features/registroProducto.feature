...
Feature: Funcionalidad de registro de producto
    ...
    Scenario: Usuario registrado realiza el registro de un nuevo producto con mas de 255 caracteres
        ...
        And  el usuario va a la página de Artículos
        And  el usuario selecciona crear un nuevo articulo
        And  el usuario crea el formulario con Código "IP-16-2025-v15", Descripción "Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium, totam rem aperiam, eaque ipsa quae ab illo inventore veritatis et quasi architecto beatae vitae dicta sunt explicabo. Nemo enim ipsam voluptatem quia voluptas sit aspernatur aut odit aut fugit, sed quia consequuntur magni dolores eos qui ratione voluptatem sequi nesciunt. Neque porro quisquam est, qui dolorem ipsum quia dolor sit amet, consectetur, adipisci velit, sed quia non numquam eius modi tempora incidunt ut labore et dolore magnam aliquam quaerat voluptatem. Ut enim ad minima veniam, quis nostrum exercitationem ullam corporis suscipit laboriosam, nisi ut aliquid ex ea commodi consequatur? Quis autem vel eum iure reprehenderit qui in ea voluptate velit esse quam nihil molestiae consequatur, vel illum qui dolorem eum fugiat quo voluptas nulla pariatur?", Stock Actual "10", Costo "1000000", Precio venta "1200000" y selecciona la unidad de medida "Unidad" 
    ...
    Scenario: Usuario registrado realiza el registro de un nuevo producto sin codigo
        When el usuario selecciona la lista desplegable de Entidades
        And  el usuario va a la página de Artículos
        And  el usuario selecciona crear un nuevo articulo
        ...
        Then el usuario ve un mensaje de error que contiene "Error : El campo código no puede estar vacío"
        And el usuario se mantiene en la página de crear un nuevo articulo
    ...
    Scenario: Usuario registrado realiza el registro de un nuevo producto con un costo negativo
        ...
        And  el usuario va a la página de Artículos
        And  el usuario selecciona crear un nuevo articulo
        And  el usuario crea el formulario con Código "IP-16-Pro-2025-v15", Descripción "Iphone 16 2025 v15", Stock Actual "10", Costo "-1000000", Precio venta "1200000" y selecciona la unidad de medida "Unidad" 
        Then el usuario ve un mensaje de error que contiene "Error : El campo costo no puede tener valores negativos"
        And el usuario se mantiene en la página de crear un nuevo articulo
    
    Scenario: Usuario registrado realiza el registro de un nuevo producto sin unidad de medida
        When el usuario selecciona la lista desplegable de Entidades
        And  el usuario va a la página de Artículos
        And  el usuario selecciona crear un nuevo articulo
        And  el usuario crea el formulario con Código "IP-16-Pro-2025-v17", Descripción "Iphone 16 2025 v17", Stock Actual "10", Costo "1000000", Precio venta "1200000" y selecciona la unidad de medida "" 
        Then el usuario ve un mensaje de éxito de artículo creado que contiene "Iphone 16 2025 v17"
        And el usuario vuelve a la página de Artículos